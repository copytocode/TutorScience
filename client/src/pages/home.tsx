...
import { Beaker, Atom, Leaf, GraduationCap, BookOpen, Trophy, Search } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Master Biology, Chemistry, and Physics with interactive lessons and practice exercises
          </p>
        ...
        <div className="mb-16">
          <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-foreground">Choose Your Level</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {levels.map((level) => (
              <Card key={level.id} className="hover-elevate active-elevate-2 transition-shadow" data-testid={`card-level-${level.id}`}>
                ...
                <CardContent>
                  <Button asChild className="w-full" data-testid={`button-explore-${level.id}`}>
        ...
        <div className="mb-12">
          <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-foreground">Subjects</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {subjects.map((subject) => (
              <Card key={subject.id} className="overflow-hidden hover-elevate active-elevate-2 transition-shadow" data-testid={`card-subject-${subject.id}`}>
                ...
                <CardContent>
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-sm text-muted-foreground">{subject.topics} topics available</span>
                  </div>
                  <Button asChild variant="outline" className="w-full" data-testid={`button-view-${subject.id}`}>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>Complete lessons and exercises to master each topic</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
